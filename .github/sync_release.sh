...
UPSTREAM_REPO="https://github.com/MiSTer-devel/PMD85_MiSTer.git"
CORE_NAME=(PMD85)
...
UPSTREAM_CORE_NAME=(PMD85)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(PMD85.qpf)
COMPILATION_OUTPUT=(output_files/PMD85.rbf)
